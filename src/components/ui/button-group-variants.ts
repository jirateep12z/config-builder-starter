...
const button_group_variants = cva(
...
type ButtonGroupVariantsProps = VariantProps<typeof button_group_variants>;

export { button_group_variants, type ButtonGroupVariantsProps };
