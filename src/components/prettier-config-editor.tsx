        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(selected_value: string) => {
                const parsed = parseInt(selected_value, 10);
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              {config.plugins.map(plugin => (
                <span
                  key={plugin}
                  className="bg-secondary text-secondary-foreground inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-4xl border border-transparent px-2 py-0.5 text-xs font-medium whitespace-nowrap"
                >
                  {plugin}
                </span>
              ))}
